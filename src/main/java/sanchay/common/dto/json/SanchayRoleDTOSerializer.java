 ...
 * @author User
 */
public class SanchayRoleDTOSerializer extends StdSerializer<SanchayRole> {

    public SanchayRoleDTOSerializer() {
        this(null);
    }

    public SanchayRoleDTOSerializer(Class<SanchayRole> t) {
        super(t);
    }

    @Override
    public void serialize(SanchayRole value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
